<header>
  <tr>
   <td width="205" height="89"><img src="pictures/logo.png" width="251" height="88" alt="Logo" />
    <hr /></td>
        <td width="713" class="right">Welcome to LegitimateComputerGoods shopping! | <a href="index.jsp">Home</a> | <a href="products.jsp">All Product</a>
            <%
            if(user_id == 0) {
            %>
            ...
            <%} else {
            %>
            | <a href="listorder.jsp"><%=user_username%>'s Orders</a> | <a href="logout.jsp">Logout</a>
            <%}%>
        </td>
      </tr>
      <tr>
